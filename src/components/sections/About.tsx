  ...
  return (
    <section className="py-32 mt-16" id="about">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <Card className="p-8 bg-black/50 backdrop-blur-sm border-white/10 hover:border-primary/50 transition-all duration-300 card-hover group">
          <p className="text-lg leading-relaxed text-gray-300 card-content">
